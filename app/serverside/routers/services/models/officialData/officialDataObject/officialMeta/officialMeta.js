...
let officialMeta = new Schema(
    {
        deviceFw: {type:Number, required:true},
        deviceModel: {type:Number, required:true},
    },
    {_id: false}
);

export default officialMeta; // we export the snapshotData model