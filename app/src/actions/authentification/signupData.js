...
export const signup = createAsyncThunk('authentification/signup', async ({ username, password }, { rejectWithValue }) => {
    try {
      // make request to backend
      const response = await fetch(`${serverUrl()}/authentification/signup`, {
        method: 'POST',
      ...
      return response === "OK" ? response : rejectWithValue(response);
    } 
    catch (error) {
