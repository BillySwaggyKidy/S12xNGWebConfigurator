...
// this action purpose is to close the a configuration on the database
export const closeOneConfiguration = createAsyncThunk('configuration/closeOneConfiguration', async ({configurationId}, { rejectWithValue }) => {
    try {
      // make request to backend
      const response = await fetch(`${serverUrl()}/configuration/closeOneConfiguration`, {
        method: 'POST',
...
export default closeOneConfiguration;