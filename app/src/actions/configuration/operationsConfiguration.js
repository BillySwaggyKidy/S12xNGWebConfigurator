...
// this action purpose is to handle all type of operations for the configuration documents in the database
export const operationsConfiguration = createAsyncThunk('configuration/operationsConfiguration', async ({status, operationParameters}, { rejectWithValue }) => {
    try {
      // make request to backend
      const response = await fetch(`${serverUrl()}/configuration/operationsConfiguration`, {
        method: 'POST',
...
export default operationsConfiguration;