...
export function ChannelsThresholdInitialsP1({valueFields, handleChangeFunction, readOnly}) {
    ...
    let arrayChannelsThresholdRowFieldsP1 = [
        ...
        {id:"p1Parameters.threshold1.time", required:true, value: valueFields?.p1Parameters.threshold1.time, condition:(value)=>value>=-Number.MAX_VALUE, width:90},
        ...
        {id:"p1Parameters.threshold2.time", required:true, value: valueFields?.p1Parameters.threshold2.time, condition:(value)=>value>=-Number.MAX_VALUE, width:90},
...
export function ChannelsThresholdInitialsP2({valueFields, handleChangeFunction, readOnly}) {
    ...
    let arrayChannelsThresholdRowFieldsP2 = [
        ...
        {id:"p2Parameters.threshold1.time", required:true, value: valueFields?.p2Parameters.threshold1.time, condition:(value)=>value>=-Number.MAX_VALUE, width:90},
        ...
        {id:"p2Parameters.threshold2.time", required:true, value: valueFields?.p2Parameters.threshold2.time, condition:(value)=>value>=-Number.MAX_VALUE, width:90},
