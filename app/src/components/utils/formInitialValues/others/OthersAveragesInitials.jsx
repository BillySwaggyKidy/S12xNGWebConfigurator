...
export function OthersAveragesInitialsText({valueFields, handleChangeFunction, readOnly}) {
...
export function OthersAveragesInitialsCardChannels({valueFields, handleChangeFunction, readOnly}) {
    const arrayActive = [
...
// this component represent all of the initials parameters of the fields in a row in the averages P1P2 table
export function OthersAveragesInitialsP1P2({valueFields, handleChangeFunction, readOnly}) {
    const arrayUnitType = [
        {value:0,label:"NU"},
        {value:1,label:"H"},
        {value:2,label:"L"},
