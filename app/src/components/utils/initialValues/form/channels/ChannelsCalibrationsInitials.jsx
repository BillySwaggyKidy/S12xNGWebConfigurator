...
export function ChannelsCalibrationsInitialsData({valueFields, handleChangeFunction, readOnly, hitClip = false}) {
    ...
    let arrayChannelCalibrationsRowFields = [
        ...
        {id:"smooth", required:true, value: valueFields.smooth, condition:(value)=>value>=0&&value<=1000, width:90},
    ];
