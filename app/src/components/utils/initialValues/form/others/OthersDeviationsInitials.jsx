...
export function OthersDeviationsInitialsActive({valueFields, handleChangeFunction, readOnly, hitClip = false}) {
    const arrayActive = [
...
// this component represent all of the initials parameters of the fields in a row in the deviations table
export function OthersDeviationsInitialsP1({valueFields, handleChangeFunction, readOnly, hitClip = false}) {
...
export function OthersDeviationsInitialsP2({valueFields, handleChangeFunction, readOnly, hitClip = false}) {
