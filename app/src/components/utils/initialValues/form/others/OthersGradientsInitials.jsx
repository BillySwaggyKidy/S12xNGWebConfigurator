...
export function OthersGradientsInitialsCardChannels({valueFields, handleChangeFunction, readOnly, hitClip = false}) {
    const arrayActive = [
...
export function OthersGradientsInitialsP1P2({valueFields, handleChangeFunction, readOnly, hitClip = false}) {
    const arrayUnitType = [
        {value:0,label:"NU"},
        {value:1,label:"H"},
        {value:2,label:"L"},
